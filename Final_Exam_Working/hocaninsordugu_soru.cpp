...
public:
	...
	virtual void uret()=0;          //
	friend ofstream & operator << (ofstream &ofs, Hayvan &hy);
	//*****************************//
};//class Hayvan
...
public:
	...
	{
		ofs<<ky.cins<<ky.kimlik_numarasi<<"\t"<<ky.yun;
		return ofs;
	}
};//class Koyun:public Hayvan
...
public:
	...
	{
		ofs<<ky.cins<<ky.kimlik_numarasi<<"\t"<<ky.sut;
		return ofs;
	}
};//class Inek:public Hayvan
...
public:
	...
	{
		ofs<<ky.cins<<ky.kimlik_numarasi<<"\t"<<ky.yumurta;
		return ofs;
	}
};//class Tavuk:public Hayvan
